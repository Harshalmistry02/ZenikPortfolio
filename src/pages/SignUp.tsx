...
export function SignUp({ user, onLogin }: SignUpProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F5] flex relative overflow-hidden font-sans selection:bg-teal-100 selection:text-teal-900">
      ...
      <Link
        to="/"
        className="absolute top-6 left-6 z-50 flex items-center justify-center space-x-2 bg-white border border-gray-200/80 text-[#00BFA6] hover:text-[#0D0F14] shadow-sm hover:shadow-md transition-all px-4 py-2.5 rounded-full group"
